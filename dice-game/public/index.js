...
btnRoll.addEventListener('click', function () {
  ...
  const name1st = document.getElementById('name--0');

  document.getElementById('nameA').addEventListener('input', (e) => {
    name1st.innerHTML = e.target.value;
  });

  const name2nd = document.getElementById('name--1');

  document.getElementById('nameB').addEventListener('input', (e) => {
    name2nd.innerHTML = e.target.value;
  });
